namespace yostocksApi.Migrations
{
    ...
    public partial class first : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        YostocksUserModel_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Stocks", t => t.StockId, cascadeDelete: true)
                .ForeignKey("dbo.YostocksUsers", t => t.YostocksUserModel_Id)
                .Index(t => t.StockId)
                .Index(t => t.YostocksUserModel_Id);
                ...
                c => new
                    {
                        ...
                        CurrencyOfPurchase = c.String(nullable: false),
        ...
        {
            DropForeignKey("dbo.Fragments", "YostocksUserModel_Id", "dbo.YostocksUsers");
            DropForeignKey("dbo.Fragments", "StockId", "dbo.Stocks");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropIndex("dbo.Fragments", new[] { "YostocksUserModel_Id" });
